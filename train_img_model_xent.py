...
def test(model, queryloader, gallery, use_gpu, ranks=[1, 5, 10, 20]):
    ...
    start_times = [
        [ 0, 10, 20,  0, 30, 60, 45, 30],
        [15,  0,  0, 20,  5, 35, 20, 10],
        [35,  5,  0, 10,  0, 30,  0,  0], # ..., 375, 690, 0]
        [ 0,  0, 10,  0, 25,  0,  0,  0],
        [40,  5,  0, 25,  0,  5,  5, 20],
        [40, 45, 65,  0,  5,  0,  0,  0],
        [40, 20,  0,  0,  0,  0,  0, 10],
        [15, 10,  0,  0, 10, 20, 10,  0]
    ]
    end_times = [
        [ 6, 45, 50,  0, 70, 75, 50, 75],
        [40,  6, 60, 35, 25, 50, 25, 35],
        [45, 20,  6, 25, 10, 35,  0,  0], # ..., 380, 700, 0]
        [ 0,  0, 25,  6, 60,  0,  0,  0],
        [60, 20, 10, 30,  6, 45, 10, 35],
        [75, 50, 70,  0, 50,  6, 40,  0],
        [45, 30,  0,  0,  5, 30,  6, 65],
        [45, 15,  0,  0, 15, 55, 30,  6]
    ]
